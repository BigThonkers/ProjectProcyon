...
\[\int_V(\varphi\vec{\Delta}\psi\,+\,(\vabla\psi\cdot\vabla\varphi))\;\mathrm{d}^3r\,=\,\oint_{S}\varphi\frac{\partial\psi}{\partial n}\;\mathrm{d}f\]
...
\[\int_V (\varphi\vec{\Delta}\psi-\psi\vec{\Delta}\varphi)\;\mathrm{d}^3r\,=\,\oint_{S}\bigg(\varphi\frac{\partial\psi}{\partial n}-\psi\frac{\partial\varphi}{\partial n}\bigg)\;\mathrm{d}^3f\]
...
\[
\Phi\,=\,\frac{1}{4\pi}\int_V \frac{\vabla '\cdot \vec{F}(\vec{r}')}{\left|\vec{r}-\vec{r}'\right|}\;\mathrm{d}V' \qquad\quad
