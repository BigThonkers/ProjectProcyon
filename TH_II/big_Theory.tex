...
Die Spiegelladung (oder Bildladung) ist eine gedankliche Hilfsstütze, um das Verhalten einer Ladung $Q$ vor einem leitenden Körper im Abstand $R$ zu veranschaulichen. Beim Fall eines Leiters wird die gesamte influenzierte Ladung dafür anschaulich zu einer Punktladung zusammengefasst. Aus Symmetriegründen wird diese Punktladung als Spiegelladung bezeichnet. (für physikalische Grundlagen siehe Appendix\ref{imagechargestheory})
